...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] text-[#2C2420] flex flex-col font-mukta selection:bg-[#FF671F] selection:text-white">
      {/* Top Header */}
      <Header
        activeTab={activeTab}
        ...
        {activeTab === 'home' && (
          <div>
            ...
            <div className="py-12 px-4 max-w-7xl mx-auto">
              <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#FF671F]/25 shadow-xl shadow-[#FF671F]/5 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-4 text-center">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-[#7A685B]">{ASTROLOGER_INFO.experience} | {ASTROLOGER_INFO.location}</p>
                  </div>
                </div>
                ...
                <div className="lg:col-span-8 space-y-4">
                  ...
                  <h3 className="font-yatra text-2xl sm:text-3xl text-[#2C2420]">
                    {lang === 'hi'
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                    <div className="flex items-center gap-2 text-xs text-[#2C2420] font-semibold bg-[#FFFDF9] p-3 rounded-2xl border border-[#FF671F]/20">
                  ...
                  <div className="pt-2 flex flex-wrap gap-3">
                    ...
                    <a
                      ...
                      className="bg-white hover:bg-[#FFF5F0] text-[#CC5218] border border-[#FF671F]/30 font-bold px-5 py-2.5 rounded-xl text-xs sm:text-sm transition-all shadow-xs flex items-center gap-1.5"
                    >
        ...
        {activeTab === 'contact' && (
          <div className="py-12 px-4 max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-10">
              <h2 className="font-yatra text-3xl sm:text-4xl text-[#CC5218] mb-2">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#FF671F]/25 shadow-xl shadow-[#FF671F]/5 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-5 rounded-2xl bg-[#FFF5F0] border border-[#FF671F]/20 space-y-3">
                  <div className="flex items-center gap-2 text-[#CC5218] font-bold text-sm">
                    <MapPin className="w-5 h-5 text-[#FF671F]" />
                    <span>कार्यालय का पूरा पता</span>
                  </div>
                  <p className="text-xs sm:text-sm text-[#2C2420] leading-relaxed">
                  ...
                  <a
                    ...
                    className="inline-block text-xs font-bold text-[#CC5218] hover:underline"
                  >
                ...
                <div className="p-5 rounded-2xl bg-[#FFF5F0] border border-[#FF671F]/20 space-y-3">
                  ...
                  <div className="text-xs text-emerald-800 font-semibold bg-emerald-50 px-3 py-1.5 rounded-lg border border-emerald-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href={`tel:${ASTROLOGER_INFO.phonePrimary}`}
                  className="bg-[#FFFDF9] hover:bg-[#FFF5F0] text-[#CC5218] border-2 border-[#FF671F] font-yatra text-base py-3 px-8 rounded-2xl transition-all text-center flex items-center justify-center gap-2"
                >
                  <Phone className="w-4 h-4" />
