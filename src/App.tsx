                ...
                <div className="lg:col-span-8 space-y-4">
                  ...
                  <div className="pt-2 flex flex-wrap gap-3">
                    ...
                    >
                      ...
                      <span>{lang === 'hi' ? 'पंडित जी से फोन पर बात करें' : 'પંડિતજી સાથે વાત કરો'}</span>
                    </a>

                    <a
                      href={`https://wa.me/${ASTROLOGER_INFO.whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('प्रणाम पंडित जी! मुझे भवानी ज्योतिष केंद्र से ज्योतिषीय परामर्श चाहिए।')}`}
                      target="_blank"
