        ...
        <div className={`lg:col-span-8 rounded-3xl p-6 border shadow-xl space-y-6 ${
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] font-bold block ${isDark ? 'text-stone-300' : 'text-stone-950'}`}>1. तिथि (Tithi)</span>
            ...
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] font-bold block ${isDark ? 'text-stone-300' : 'text-stone-950'}`}>2. नक्षत्र (Nakshatra)</span>
            ...
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] font-bold block ${isDark ? 'text-stone-300' : 'text-stone-950'}`}>3. पक्ष (Paksha)</span>
            ...
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] font-bold block ${isDark ? 'text-stone-300' : 'text-stone-950'}`}>4. योग (Yoga)</span>
            ...
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] font-bold block ${isDark ? 'text-stone-300' : 'text-stone-950'}`}>5. करण (Karana)</span>
            ...
            <div className={`p-3.5 rounded-2xl border ${
              ...
              <span className={`text-[11px] block ${isDark ? 'text-amber-300' : 'text-amber-800'}`}>शुभ मुहूर्त (Abhijit)</span>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className={`rounded-3xl p-6 border shadow-xl space-y-4 ${
            ...
            <div className={`p-3 rounded-2xl border ${
              ...
              <span className={`text-xs font-bold block ${isDark ? 'text-rose-300' : 'text-rose-800'}`}>⚠️ राहुकाल (Rahu Kaal)</span>
              <span className={`text-sm font-bold block mt-0.5 ${isDark ? 'text-rose-200' : 'text-rose-950'}`}>{TODAY_PANCHANG.rahuKaal}</span>
              <span className={`text-[11px] block mt-1 ${isDark ? 'text-rose-300/80' : 'text-rose-700'}`}>इस समय नया कार्य, यात्रा या लेन-देन आरंभ न करें।</span>
            </div>

            <div className={`p-3 rounded-2xl border ${
              isDark ? 'bg-amber-950/30 border-amber-500/30' : 'bg-amber-50 border-amber-200'
            }`}>
              <span className={`text-xs font-bold block ${isDark ? 'text-amber-300' : 'text-amber-800'}`}>यमगण्ड (Yamaganda)</span>
            ...
            <div className={`p-3 rounded-2xl border ${
              ...
              <span className={`text-xs font-bold block ${isDark ? 'text-stone-300' : 'text-slate-700'}`}>गुलिक काल (Gulika Kaal)</span>
